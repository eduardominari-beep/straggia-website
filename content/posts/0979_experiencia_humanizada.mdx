...
Gabriela Pilon Minari é cofundadora e executiva de operações da Straggia Consultoria. Com mais de 15 anos de atuação em projetos de live marketing, atendimento ao cliente e operação de experiências, conecta estratégia, cuidado e execução para transformar jornadas em relações mais consistentes entre marcas e pessoas.

Sua trajetória inclui experiência no setor hoteleiro, com passagens por Atlantica Hotels e Intercity Hotels, além da coordenação de projetos complexos, equipes multidisciplinares, fornecedores, orçamentos e operações em campo. Também atuou em iniciativas e eventos de grande porte, como iFood-Move, D23 - Disney e CCXP.

Na Straggia, Gabriela contribui com uma visão prática sobre experiência do cliente, qualidade operacional e presença humana nas jornadas de relacionamento. Seu trabalho combina planejamento, sensibilidade, controle de execução e atenção aos detalhes que tornam uma experiência mais fluida, memorável e confiável.
...
Gabriela Pilon Minari is co-founder and operations executive at Straggia Consultoria. With more than 15 years of experience in live marketing, customer service and experience operations, she connects strategy, care and execution to turn customer journeys into more consistent relationships between brands and people.

Her background includes experience in the hospitality sector, with roles at Atlantica Hotels and Intercity Hotels, as well as the coordination of complex projects, multidisciplinary teams, suppliers, budgets and field operations. She has also worked on large-scale initiatives and events such as iFood-Move, D23 - Disney and CCXP.

At Straggia, Gabriela brings a practical perspective on customer experience, operational quality and human presence across relationship journeys. Her work combines planning, sensitivity, execution control and attention to the details that make an experience more fluid, memorable and reliable.
